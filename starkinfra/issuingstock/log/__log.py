...
class Log(Resource):
    ...
    - type [string]: type of the IssuingStock event which triggered the log creation. ex: "blocked", "canceled", "created", "unblocked", "updated"
    - created [datetime.datetime]: creation datetime for the log. ex: datetime.datetime(2020, 3, 10, 10, 30, 0, 0)
    """

    def __init__(self, id, stock, type, created):
...
def query(ids=None, limit=None, after=None, before=None, types=None, stock_ids=None, user=None):
...
def page(cursor=None, ids=None, limit=None, after=None, before=None, types=None, stock_ids=None, user=None):
