...
class Log(Resource):
    ...
    - type [string]: type of the IssuingRestock event which triggered the log creation. ex: "blocked", "canceled", "created", "unblocked", "updated"
...
def query(ids=None, limit=None, after=None, before=None, types=None, restock_ids=None, user=None):
...
def page(cursor=None, ids=None, limit=None, after=None, before=None, types=None, restock_ids=None, user=None):
